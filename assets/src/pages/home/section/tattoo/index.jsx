...
const Tattoo = () => {
  ...
  return (
    <section id="tattoo" className=" bg-white">
      <div className="flex items-center justify-center  py-8 my-12 ">
      ...
      <div className="my-24">
        <div className="flex justify-center text-center items-center  my-8">
          <MovingText
            ...
            fillMode="forwards"
          >
            Besoin d'un coup de pouce créatif ? Nous sommes là pour transformer
